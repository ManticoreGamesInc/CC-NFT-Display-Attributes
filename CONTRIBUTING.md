...
Interested in contributing to CC-NFT-Display-Attributes? Want to report a bug?
...
[2]: https://github.com/ManticoreGamesInc/CC-NFT-Display-Attributes
...
3. **Pull Request**: After making sure everything passes, commit your changes,
   push your branch to GitHub and send a PR to `ManticoreGamesInc/CC-NFT-Display-Attributes:main`.
